				...
				<div class="">
					...
					<div class="container-login100">
						<div class="wrap-login100 p-6">
							<form action="form2.php" method="POST"class="login100-form validate-form">
								<span class="login100-form-title">
									Login
								</span>
								<div class="wrap-input100 validate-input" data-validate = "Valid name is required:" >
									<input class="input100" type="text" id="name" name="name" placeholder="Name" required="name is required">
								...
								<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
									<input class="input100 checking-email" id="email" type="text" name="email" placeholder="Email" required="email is required: ex@abc.xyz">
									<span id="availability" class="focus-input100"></span>
								...
								<div class="wrap-input100 validate-input" data-validate = "Password is required">
									<input class="input100" type="password" id="password" name="password" placeholder="Password" required="password is required">
									<span class="focus-input100"></span>
									<span class="symbol-input100">
								...
								<div class="container-login100-form-btn">
									<button type="btn" id="login" name="login" class="login100-form-btn btn-primary">
										Login<!-- a href="#" --> 
									<!-- </a> -->
								</div>
								<div class="text-center pt-3">
									<!-- <p class="text-dark mb-0">Not a member? --><a href="register_new.php" class="text-primary ml-1">Sign UP now</a><!-- </p> -->
								</div>
