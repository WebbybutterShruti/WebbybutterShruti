<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
				<aside class="app-sidebar">
					...
					<ul class="side-menu">
						...
						<li>
						<a href="index_new1.php"><!-- abc -->
							<div class="side-menu__item" >
							<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" class="side-menu__icon"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M3 4h18v10H3z" opacity=".3"/><path d="M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7l-2 3v1h8v-1l-2-3h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 12H3V4h18v10z"/></svg>

							<span class="side-menu__label">Student</span><i class="angle fa fa-angle-right"></i>
							</div>
						</a>
					</li>
                     ...
                     <!-- <li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#">
								...
								<span class="side-menu__label">Posts</span><i class="angle fa fa-angle-right"></i>
							</a>
							<ul class="slide-menu">
								<li><a href="add_post.php" class="slide-item">Add Post</a></li>
								<li><a href="post.php" class="slide-item">View All Post</a></li>
						 ...
						 <li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="comment1.php" class="slide-item">Comment</a></li>
								<li><a href="view_comment.php" class="slide-item">View All Comment</a></li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="view_user.php" class="slide-item">View User</a></li>
								<li><a href="add_user.php" class="slide-item">Add User</a></li>
                ...
                <!--              <a href="search.php">
                             	<li>
                            <a class="side-menu__item"  data-toggle="slide" href="search.php">
								<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" class="side-menu__icon"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M3 4h18v10H3z" opacity=".3"/><path d="M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7l-2 3v1h8v-1l-2-3h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 12H3V4h18v10z"/></svg>
								<span class="side-menu__label">Student</span><i class="angle fa fa-angle-right"></i>
