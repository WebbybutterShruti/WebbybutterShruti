...
//for check if user id ma session create na thayu hoy to a profile page ne access nahi kari sake 
//atle pehla user a login karvu pdse to j a profile page per jai sakse
if(!$_SESSION['name'])
{
   ?>
 <!-- <script>
