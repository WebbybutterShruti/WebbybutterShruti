					...
					<div class="container-login100">
						<div class="wrap-login100 p-6">
							<form action="form2.php" method="POST" class="login100-form validate-form">
								...
								<!-- 	<a href="#" class="login100-form-btn btn-primary"name="login">
										Login
									</a> -->
									<input type="submit" class="login100-form-btn btn-primary" name="submit" value="login">
								</div>
								<div class="text-center pt-3">
									<a href="register.php" class="text-primary ml-1">Sign UP now</a></p>
								</div>
