							...
							<div class="header-search d-none d-md-flex">
								...
								<form action="" method="post" class="form-inline">
									...
									<div class="search-element">
										<input type="text" name="search" class="form-control header-search" placeholder="Search…" aria-label="Search" tabindex="1">
										<button class="btn btn-primary-color" type="submit" name="submit">
							...
							<div class="d-flex ml-auto header-right-icons header-search-icon">
								...
								<div class="dropdown profile-1">
									...
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
										...
										<a class="dropdown-item" href="login_new.php">
